...
/**
  ...
  **/
object HbaseColumnCount extends SparkUtil with HbaseUtil with Until{
...
//    hbaseBase.repartition(1).saveAsTextFile("/xing/jar/hbase_data_2019_7_30")
//    getHbaseColumnCount(sc,hiveContext)
