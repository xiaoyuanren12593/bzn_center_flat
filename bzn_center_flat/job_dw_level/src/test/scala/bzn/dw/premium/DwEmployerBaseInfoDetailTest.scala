...
import bzn.dw.premium.DwEmployerBaseInfoDetail.clean
...
*/
 object DwEmployerBaseInfoDetailTest extends SparkUtil with Until {
  def main(args: Array[String]): Unit = {
    ...
    DwEmployerBaseInfoDetail(hiveContext)
  ...
  def DwEmployerBaseInfoDetail(sqlContext: HiveContext) = {
    ...
    odsPolicyDetailInsureTemp.selectExpr("belongs_regional", "belongs_regional_salve","policy_code")
      .where("policy_code = 'HL1100000064004088'").show(100)
    /**
      * 读取地域信息码表
      */
