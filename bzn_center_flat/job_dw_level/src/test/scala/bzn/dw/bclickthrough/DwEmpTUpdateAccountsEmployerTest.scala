...
import bzn.dw.bclickthrough.DwTAccountsEmployer.{clean, sparkConfInfo}
...
* @Date：2019/11/4
* @Describe:
*/ object DwEmpTUpdateAccountsEmployerTest extends SparkUtil with Until{
  ...
  def main(args: Array[String]): Unit = {
   ...
   // res.repartition(20).write.mode(SaveMode.Append).saveAsTable("dwdb.dw_t_accounts_employer_detail")
   sc.stop()
  }
