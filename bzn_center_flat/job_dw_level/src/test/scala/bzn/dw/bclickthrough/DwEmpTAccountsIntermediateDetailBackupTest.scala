...
* @Describe:
*/
object DwEmpTAccountsIntermediateDetailBackupTest extends SparkUtil with MysqlUntil {
  def main(args: Array[String]): Unit = {
    ...
    res.repartition(1).write.mode(SaveMode.Append).saveAsTable("dwdb.dw_t_accounts_employer_detail_backup")
    sc.stop()
  }
}