...
/**
  ...
  **/
object DwSaleEasyPolicyCurrInsuredDetail extends SparkUtil with Until{
  def main(args: Array[String]): Unit = {
    ...
    hiveContext.sql("truncate table dwdb.dw_saleeasy_policy_curr_insured_detail")
    res.repartition(10).write.mode(SaveMode.Append).saveAsTable("dwdb.dw_saleeasy_policy_curr_insured_detail")
    res.cache()
