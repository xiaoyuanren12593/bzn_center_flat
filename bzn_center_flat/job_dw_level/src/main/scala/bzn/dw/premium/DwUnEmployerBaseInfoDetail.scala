...
/**
  ...
  * describe: 非雇主基础信息表
  **/
object DwUnEmployerBaseInfoDetail extends  SparkUtil with  Until{
  ...
  def main(args: Array[String]): Unit = {
    ...
    hiveContext.sql("truncate table dwdb.dw_un_employer_baseinfo_detail")
    res.repartition(10).write.mode(SaveMode.Append).saveAsTable("dwdb.dw_un_employer_baseinfo_detail")
    sc.stop ()
  }
