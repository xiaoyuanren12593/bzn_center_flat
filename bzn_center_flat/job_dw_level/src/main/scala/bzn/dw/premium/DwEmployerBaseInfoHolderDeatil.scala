...
* @Date：2019/11/8
* @Describe:
*/ object DwEmployerBaseInfoHolderDeatil  extends SparkUtil with Until with MysqlUntil {
  /**
    * 获取配置信息
    *
    * @param args
  ...
  def main(args: Array[String]): Unit = {
    ...
    hqlContext.sql("truncate table dwdb.dw_customer_base_holder_detail")
    res.write.mode(SaveMode.Append).saveAsTable("dwdb.dw_customer_base_holder_detail")

    sc.stop()

  }

  def  EmployerBaseInfoHolder(hqlContext:HiveContext): DataFrame ={
