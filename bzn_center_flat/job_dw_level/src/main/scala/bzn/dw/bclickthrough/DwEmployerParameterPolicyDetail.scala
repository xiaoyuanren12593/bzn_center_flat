...
* @Date：2019/10/29
* @Describe:
*/ object DwEmployerParameterPolicyDetail  extends SparkUtil with Until{
  ...
  def main(args: Array[String]): Unit = {
    ...
    val res = EmployerParameterPolicyDetai(hqlContext)
  ...
  def EmployerParameterPolicyDetai(hqlCotext:HiveContext): DataFrame ={
