...
import bzn.ods.accounts.OdsEmpTAccountsIntermediateDetailToHive.{clean, readMysqlTable}
...
* @Describe:
*/
object OdsEmpTAccountsIntermediateDetailToHiveTest extends SparkUtil with Until with MysqlUntil {
