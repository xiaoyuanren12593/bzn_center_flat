...
* @Date：2019/12/11
* @Describe:
*/ object OdsUnEmpTAccountsIntermediateDetailToHiveTest extends SparkUtil with Until with MysqlUntil {
  def main(args: Array[String]): Unit = {
    ...
    res.printSchema()
    hqlContext.sql("truncate table odsdb.ods_t_accounts_un_employer_intermediate")

    res.write.mode(SaveMode.Append).saveAsTable("odsdb.ods_t_accounts_un_employer_intermediate")
