...
/**
  ...
  * describe: 工种类别明细表
  **/
object OdsWorkGradeDetailTest extends SparkUtil with Until with DataBaseUtil{
  def main(args: Array[String]): Unit = {
    ...
    /**
      ...
      */
    getOdsWorkGradeInfo(hiveContext)
    sc.stop()
  ...
  /**
    ...
    */
  def getOdsWorkGradeInfo(sqlContext:HiveContext) = {
