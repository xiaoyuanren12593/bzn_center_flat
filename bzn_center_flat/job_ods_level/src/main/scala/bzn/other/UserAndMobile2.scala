...
object UserAndMobile2 extends SparkUtil with Until{
...
//    清晰标签
    ...
    result.rdd.repartition(1).saveAsTextFile("hdfs://172.16.11.106:8020/xing/data/userAndMobile2")
  ...
  def readMysqlProTable(sqlContext: SQLContext): DataFrame = {
    ...
    val result: DataFrame = sqlContext
      ...
      .selectExpr("product_code as product_codes", "product_new_2 as product_name")
