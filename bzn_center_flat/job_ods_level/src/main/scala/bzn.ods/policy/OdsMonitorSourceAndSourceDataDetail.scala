...
/**
  ...
  **/
object OdsMonitorSourceAndSourceDataDetail extends SparkUtil with DataBaseUtil with OdsMonitorTool{
  ...
  /**
    ...
    */
  def getCentralBaseMonitor(sqlContext:HiveContext): Unit = {
    ...
    val resTable = "dm_monitor_source_data_Detail" //1。0系统元数据表
...
//    val url103 = "mysql_url.103.odsdb"
    ...
    saveASMysqlTable(res: DataFrame, resTable: String, SaveMode.Overwrite,officialUser:String,officialPass:String,driver:String,officialUrlDmdb:String)
  }
}
