...
/**
  ...
  **/
object Canal2MysqlDmGraylistEntTable extends SparkUtil  with ToMysqlUtilsPare {
  def main (args: Array[String]): Unit = {
    ...
    /**
      * ############################---kafka的配置----##########################################
      */
    val groupId = "group_dm_graylist_ent"
    val clientId = "client_dm_graylist_ent"
