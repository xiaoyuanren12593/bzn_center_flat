...
import bzn.utils.ToMysqlUtilsPare
...
/**
  ...
  **/
object Canal2MysqlDmEntRuleRelationTable extends SparkUtil  with ToMysqlUtilsPare {
  def main (args: Array[String]): Unit = {
    ...
    /**
      * ############################---kafka的配置----##########################################
      */
    val groupId = "group_dm_ent_rule_relation"
    val clientId = "client_dm_ent_rule_relation"

    val kafkaParam: Map[String, String] = Map[String, String](
      //-----------kafka低级api配置-----------
      "zookeeper.connect" -> "172.16.11.105:2181,172.16.11.106:2181,172.16.11.103:2181", //----------配置zookeeper-----------
      "metadata.broker.list" -> "172.16.11.103:9092,172.16.11.104:9092,172.16.11.106:9092",
    ...
    val table = "dm_ent_rule_relation"
    ...
    /**
      * 表名
      */
    val tableName = "dm_ent_rule_relation"
