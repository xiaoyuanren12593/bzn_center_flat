...
/**
  ...
  **/
object Canal2MysqlDmGraylistRuleTable extends SparkUtil  with ToMysqlUtilsPare {
  def main (args: Array[String]): Unit = {
    ...
    /**
      * ############################---kafka的配置----##########################################
      */
    val groupId = "group_dm_graylist_rule"
    val clientId = "client_dm_graylist_rule"
    ...
    /**
      * 表名
      */
    val tableName = "dm_graylist_rule"
