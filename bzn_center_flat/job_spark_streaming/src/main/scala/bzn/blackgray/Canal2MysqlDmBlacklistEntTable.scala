...
/**
  ...
  **/
object Canal2MysqlDmBlacklistEntTable extends SparkUtil  with ToMysqlUtilsPare {
  def main (args: Array[String]): Unit = {
    ...
    /**
      * ############################---kafka的配置----##########################################
      */
    val groupId = "group_dm_blacklist_ent"
    val clientId = "client_dm_blacklist_ent"
    ...
    /**
      * 表名
      */
    val tableName = "dm_blacklist_ent"
